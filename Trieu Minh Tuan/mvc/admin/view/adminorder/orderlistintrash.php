...
<table class="table">
  ...
  foreach($orders as $o){?>
    <tr>
      ...
      <td class=text-center><?php if($o['status']==1) echo 'Processing'; else echo 'Done' ?></td>
      <td class=text-center><a data-toggle="tooltip" title="Xóa vĩnh viễn" href='<?php echo BASE_URL ?>adminorder/orderDelete/<?php echo $o["orderId"]?>' onclick='return confirm("Bạn có chắc muốn xoá vĩnh viễn đơn hàng này không ?")'><i class="me-1   fas fa-eraser"></i></a>|<a href='<?php echo BASE_URL ?>adminorder/toggleTrash/<?php echo $o["orderId"]?>'><i class="ms-1 fas fa-trash-restore"></i></a></td>
      <td class=text-center><td class=text-center >|<a href='<?php echo BASE_URL?>adminorder/orderDetail/<?php echo $o['orderId']?>'><i class="fas fa-stream"></i></a></td>
    </tr>
  <?php }?>  
  </tbody>
</table>
