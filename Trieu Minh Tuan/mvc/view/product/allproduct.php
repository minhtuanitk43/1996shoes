...
<div class="row">
  <div class="col alert alert-primary fw-bold fs-5 text-center"><h1 class='text-uppercase'>Tất cả sản phẩm</h1></div>
  <h5 class='text-secondary fs-5'>Có tất cả <?php echo $totalRecords?> sản phẩm</h5>
...
<div class="row"><!--row 01-->
  <?php foreach($products as $product){?>
    <div class="col-md-4 col-sm-6 text-center card">
        ...
        <a class='fs-5 text-decoration-none' href="<?php echo BASE_URL.'index.php?req=product/productDetail/'.$product['alias']?>" class=text-decoration-none class="card-title"><?php echo $product['productName'] ?></a>
          <p class="card-text"> 
          <?php
